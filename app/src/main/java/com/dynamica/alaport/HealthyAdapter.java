...
public class HealthyAdapter extends RecyclerView.Adapter<HealthyAdapter.MyViewHolder>{
    ...
    HealthyAdapter(ArrayList<String> a, Context context){
        arrs=a;this.context=context;
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup groupm,int viewType){
        View itemView= LayoutInflater.from(groupm.getContext()).inflate(R.layout.healthy_row,groupm,false);
    ...
    public  void onBindViewHolder(MyViewHolder holder,final int position){
        ...
        holder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,HealthyInfoActivity.class);
